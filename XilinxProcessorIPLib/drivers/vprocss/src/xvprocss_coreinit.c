...
int XVprocSs_SubcoreInitResetAxis(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->RstAxisPtr) {
        ...
        if (pConfig == NULL) {
            XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_INIT_RESAXIS,
                              XVPROCSS_EDAT_CFABSENT);
            return (XST_FAILURE);
        }

        /* Compute absolute base address */
        AbsAddr = 0;
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.RstAxis.AddrOffset, &AbsAddr);

        if (status != XST_SUCCESS) {
            XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_INIT_RESAXIS,
                              XVPROCSS_EDAT_BADADDR);
            return (XST_FAILURE);
        }

        /* Initialize core */
        status = XGpio_CfgInitialize(XVprocSsPtr->RstAxisPtr, pConfig, AbsAddr);

        if (status != XST_SUCCESS) {
            XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_INIT_RESAXIS,
                              XVPROCSS_EDAT_INITFAIL);
            return (XST_FAILURE);
        }
    }

    XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_INIT_RESAXIS,
                      XVPROCSS_EDAT_INITOK);
    return (XST_SUCCESS);
}
...
int XVprocSs_SubcoreInitResetAximm(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->RstAximmPtr) {
        ...
        if (pConfig == NULL) {
            XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_INIT_RESAXIM,
                              XVPROCSS_EDAT_CFABSENT);
            return (XST_FAILURE);
        }
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.RstAximm.AddrOffset, &AbsAddr);
        ...
        /* Initialize core */
        status =
            XGpio_CfgInitialize(XVprocSsPtr->RstAximmPtr, pConfig, AbsAddr);
...
int XVprocSs_SubcoreInitRouter(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->RouterPtr) {
        ...
        if (pConfig == NULL) {
            XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_INIT_ROUTER,
                              XVPROCSS_EDAT_CFABSENT);
            return (XST_FAILURE);
        }
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.Router.AddrOffset, &AbsAddr);
        ...
        /* Initialize core */
        status =
            XAxisScr_CfgInitialize(XVprocSsPtr->RouterPtr, pConfig, AbsAddr);
...
int XVprocSs_SubcoreInitCsc(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->CscPtr) {
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.Csc.AddrOffset, &AbsAddr);
        ...
        /* Initialize core */
        status =
            XV_csc_CfgInitialize(&XVprocSsPtr->CscPtr->Csc, pConfig, AbsAddr);
...
int XVprocSs_SubcoreInitHScaler(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->HscalerPtr) {
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.Hscale.AddrOffset, &AbsAddr);
...
int XVprocSs_SubcoreInitVScaler(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->VscalerPtr) {
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.Vscale.AddrOffset, &AbsAddr);
...
int XVprocSs_SubcoreInitHCrsmplr(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->HcrsmplrPtr) {
        /* Get core configuration */
        pConfig =
            XV_hcresampler_LookupConfig(XVprocSsPtr->Config.HCrsmplr.DeviceId);
        if (pConfig == NULL) {
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.HCrsmplr.AddrOffset, &AbsAddr);
        ...
        if (XVprocSsPtr->HcrsmplrPtr->Hcr.Config.ResamplingType ==
...
int XVprocSs_SubcoreInitVCrsmpleIn(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->VcrsmplrInPtr) {
        /* Get core configuration */
        pConfig = XV_vcresampler_LookupConfig(
            XVprocSsPtr->Config.VCrsmplrIn.DeviceId);
        if (pConfig == NULL) {
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.VCrsmplrIn.AddrOffset, &AbsAddr);
        ...
        if (XVprocSsPtr->VcrsmplrInPtr->Vcr.Config.ResamplingType ==
...
int XVprocSs_SubcoreInitVCrsmpleOut(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->VcrsmplrOutPtr) {
        /* Get core configuration */
        pConfig = XV_vcresampler_LookupConfig(
            XVprocSsPtr->Config.VCrsmplrOut.DeviceId);
        if (pConfig == NULL) {
            XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_CFG_VCRO,
                              XVPROCSS_EDAT_CFABSENT);
            return (XST_FAILURE);
        }
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.VCrsmplrOut.AddrOffset, &AbsAddr);
        ...
        if (XVprocSsPtr->VcrsmplrOutPtr->Vcr.Config.ResamplingType ==
            XV_VCRSMPLR_TYPE_FIR) {
            /* Load default filter coefficients */
...
int XVprocSs_SubcoreInitLetterbox(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->LboxPtr) {
        ...
        if (pConfig == NULL) {
            XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_INIT_LBOX,
                              XVPROCSS_EDAT_CFABSENT);
            return (XST_FAILURE);
        }
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.Lbox.AddrOffset, &AbsAddr);
...
int XVprocSs_SubcoreInitVdma(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->VdmaPtr) {
        ...
        if (pConfig == NULL) {
            XVprocSs_LogWrite(XVprocSsPtr, XVPROCSS_EVT_INIT_VDMA,
                              XVPROCSS_EDAT_CFABSENT);
            return (XST_FAILURE);
        }
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.Vdma.AddrOffset, &AbsAddr);
        ...
        /* Initialize core */
        status = XAxiVdma_CfgInitialize(XVprocSsPtr->VdmaPtr, pConfig, AbsAddr);
...
int XVprocSs_SubcoreInitDeinterlacer(XVprocSs* XVprocSsPtr) {
    ...
    if (XVprocSsPtr->DeintPtr) {
        /* Get core configuration */
        pConfig =
            XV_deinterlacer_LookupConfig(XVprocSsPtr->Config.Deint.DeviceId);
        if (pConfig == NULL) {
        ...
        status = ComputeSubcoreAbsAddr(
            XVprocSsPtr->Config.BaseAddress, XVprocSsPtr->Config.HighAddress,
            XVprocSsPtr->Config.Deint.AddrOffset, &AbsAddr);
