...
XVprocSs_Config XVprocSs_ConfigTable[] = {{
    ...
    {XPAR_V_PROC_SS_0_AXI_VDMA_PRESENT, XPAR_V_PROC_SS_0_AXI_VDMA_DEVICE_ID,
    ...
    {XPAR_V_PROC_SS_0_CSC_PRESENT, XPAR_V_PROC_SS_0_CSC_DEVICE_ID,
     XPAR_V_PROC_SS_0_CSC_S_AXI_CTRL_BASEADDR},
    {XPAR_V_PROC_SS_0_DINT_PRESENT, XPAR_V_PROC_SS_0_DINT_DEVICE_ID,
     XPAR_V_PROC_SS_0_DINT_S_AXI_CTRL_BASEADDR},
    {XPAR_V_PROC_SS_0_HCR_PRESENT, XPAR_V_PROC_SS_0_HCR_DEVICE_ID,
     XPAR_V_PROC_SS_0_HCR_S_AXI_CTRL_BASEADDR},
    {XPAR_V_PROC_SS_0_HSC_PRESENT, XPAR_V_PROC_SS_0_HSC_DEVICE_ID,
     XPAR_V_PROC_SS_0_HSC_S_AXI_CTRL_BASEADDR},
    {XPAR_V_PROC_SS_0_LTR_PRESENT, XPAR_V_PROC_SS_0_LTR_DEVICE_ID,
     XPAR_V_PROC_SS_0_LTR_S_AXI_CTRL_BASEADDR},
    {XPAR_V_PROC_SS_0_VCR_I_PRESENT, XPAR_V_PROC_SS_0_VCR_I_DEVICE_ID,
     XPAR_V_PROC_SS_0_VCR_I_S_AXI_CTRL_BASEADDR},
    {XPAR_V_PROC_SS_0_VCR_O_PRESENT, XPAR_V_PROC_SS_0_VCR_O_DEVICE_ID,
     XPAR_V_PROC_SS_0_VCR_O_S_AXI_CTRL_BASEADDR},
    {XPAR_V_PROC_SS_0_VSC_PRESENT, XPAR_V_PROC_SS_0_VSC_DEVICE_ID,
